...
#define MBED_CONF_FLASHIAP_BLOCK_DEVICE_BASE_ADDRESS                          0x00200000                                                                                       // set by library:flashiap-block-device[FVP_MPS2]
#define MBED_CONF_FLASHIAP_BLOCK_DEVICE_SIZE                                  0x200000                                                                                         // set by library:flashiap-block-device[FVP_MPS2]
...
#define MBED_CONF_STORAGE_TDB_INTERNAL_INTERNAL_BASE_ADDRESS                  0x00200000                                                                                       // set by library:storage_tdb_internal[FVP_MPS2]
#define MBED_CONF_STORAGE_TDB_INTERNAL_INTERNAL_SIZE                          0x200000                                                                                         // set by library:storage_tdb_internal[FVP_MPS2]
...
#define MBED_CONF_TARGET_NETWORK_DEFAULT_INTERFACE_TYPE                       ETHERNET                                                                                         // set by target:FVP_MPS2
